    ...
    <body>  <?php  include 'class/Connection.class.php'; include 'class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px; max-width: none;">
                ...
                <span> <a href="index.php"><?php echo mo_get_data(1, 1); ?></a> > Sitemap </span>
                <br />
                <br />
                <h1><b>Sitemap</b></h1>
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%; height: auto;">
                        <h3><b><a href="index.php"><?php echo mo_get_data(1, 1); ?></a></b></h3>
                        <ul style="font-weight: bold"><a href="conocenos/conocenos.php"><?php echo mo_get_data(1, 2); ?></a></ul>
                            <li><a href="conocenos/mensaje_del_gerente.php"><?php echo mo_get_data(1, 3); ?></a></li>
                            <li><a href="conocenos/mision_y_vision.php"><?php echo mo_get_data(1, 4); ?></a></li>
                            <li><a href="conocenos/valores.php"><?php echo mo_get_data(1, 5); ?></a></li>
                            <li><a href="conocenos/equipo_de_trabajo.php"><?php echo mo_get_data(1, 6); ?></a></li>
                        <ul style="font-weight: bold"><a href="que_hacemos/que_hacemos.php"><?php echo mo_get_data(1, 7); ?></a></ul>
                            <li><a href="que_hacemos/unidad_gruas_y_proyectos.php"><?php echo mo_get_data(1, 8); ?></a></li>
                            <li><a href="que_hacemos/unidad_fajas_transportadoras.php"><?php echo mo_get_data(1, 9); ?></a></li>
                            <li><a href="que_hacemos/unidad_servicio_tecnico.php"><?php echo mo_get_data(1, 11); ?></a></li>
                            <li><a href="que_hacemos/unidad_comercial.php"><?php echo mo_get_data(1, 12); ?></a></li>
                         <ul style="font-weight: bold"><a href="productos/productos.php"><?php echo mo_get_data(1, 25); ?></a></ul>
                            <li><a href="productos/productos.php?filtro=categorias"><?php echo mo_get_data(1, 26); ?></a></li>
                            <li><a href="productos/productos.php?filtro=marcas"><?php echo mo_get_data(1, 27); ?></a></li>
                         <ul style="font-weight: bold"><a href="SIG/sig.php"><?php echo mo_get_data(1, 13); ?></a></ul>
                            <li><a href="SIG/politica.php"><?php echo mo_get_data(1, 14); ?></a></li>
                            <li><a href="SIG/garantia.php"><?php echo mo_get_data(1, 15); ?></a></li>
                            <li><a href="SIG/reclamos.php"><?php echo mo_get_data(1, 16); ?></a></li>
                         <ul style="font-weight: bold"><a href="trabaje_con_nosotros/trabaje_con_nosotros.php"><?php echo mo_get_data(1, 17); ?></a></ul>
                            <li><a href="trabaje_con_nosotros/porque_movitecnica.php"><?php echo mo_get_data(1, 18); ?></a></li>
