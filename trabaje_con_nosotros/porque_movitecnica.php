    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px; max-width: none;">
                ...
                <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="trabaje_con_nosotros.php"><?php echo mo_get_data(1, 17); ?> </a> > <?php echo mo_get_data(1, 18); ?> </span>
                <br />
                <br />
                <h1><b><?php echo mo_get_data(1, 18); ?></b></h1>
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%; height: auto;">
                        <div class="image_box"><img src="../userfiles/<?php echo mo_get_data(2, 18); ?>"></div><br />
                        <?php echo mo_get_data(3, 18); ?>
                    </div>
                </div>
