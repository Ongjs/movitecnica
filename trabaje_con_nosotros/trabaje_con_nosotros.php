    ...
    <body>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px; max-width: none;">
                ...
                <span> <a href="../index.html">Inicio</a> > Trabaje con Nosotros </span>
                <br />
                <br />
                <h1><b>Trabaje con Nosotros</b></h1>
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%; height: auto;">
                        <div class="image_box"><img src="../images/trabaje_con_nosotros.png"></div><br />
