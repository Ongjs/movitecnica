...
$j(document).ready(function() {
    ...
    if ($j('.accordion').length) {
        $j("ul.accordion li").each(function() {
            $j(this).children(".accordion_content").css('height', "auto");
            $j(this).children(".accordion_content").css('display', 'none');
            $j(this).children(".accordion_head").bind("click", function() {
                if ($j(this).hasClass("active")) {
                     $j(this).parent().children(".accordion_content").slideUp();
                     $j(this).parent().children(".accordion_head").removeClass("active"); 
                }else{
                $j(this).addClass("active");
