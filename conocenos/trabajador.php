        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    ...
                    ?>
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="conocenos.php"><?php echo mo_get_data(1, 2); ?></a> > <a href="equipo_de_trabajo.php"><?php echo mo_get_data(1, 6); ?></a> > <?php echo $data[0] ?> </span>
                    <br />
                    <br />
