        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    ...
                    ?>
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="Conocenos.php"><?php echo mo_get_data(1, 2); ?></a> > <a href="equipo_de_trabajo.php"><?php echo mo_get_data(1, 20); ?></a> > <?php echo $data[0] ?> </span>
                    <br />
                    <br />
                    ...
                    <div style="display: inline-block;" class="uni_response">
                        <div style="width: 98%;">
                            <div class="image_box"><img src="../userfiles/<?php echo $data[1] ?>"></div><br />
                            <?php echo $data[2] ?>
                            <br /><br />
                        </div>
                    </div>
