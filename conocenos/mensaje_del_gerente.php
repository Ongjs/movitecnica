    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
                        ...
                        <div class="twelve columns">
                            ...
                            <div class="header_right">
                                <div id="top_menu" class="menu-navigation-container"><ul id="mainmenu" class="sf-menu">
                                        ...
                                        <li id="menu-item-1126"  ><a href="Conocenos.php">Conócenos</a>
                                            <ul class="sub-menu">
        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                ...
                <span> <a href="../index.html">Inicio</a> > <a href="Conocenos.php">Conocenos</a> > <?php echo mo_get_data(1, 3); ?></span>
                <br />
                <br />
                <h1><b><?php echo mo_get_data(1, 3); ?></b></h1>
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%;">
                    <div class="image_box">
                        <img src="../images/<?php echo mo_get_data(2, 3); ?>"></div><br />
                    <?php echo mo_get_data(3, 3); ?>
                    </div>
                </div>
