    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                ...
                <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="conocenos.php"><?php echo mo_get_data(1, 2); ?></a> > <?php echo mo_get_data(1, 3); ?></span>
                <br />
                <br />
                ...
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%;">
                    <div class="image_box">
                        <img src="../userfiles/<?php echo mo_get_data(2, 3); ?>"></div><br />
