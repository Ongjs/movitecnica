        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="conocenos.php"><?php echo mo_get_data(1, 2); ?></a> > <?php echo mo_get_data(1, 4); ?></span>
                    <br />
                    <br />
                    <h1><b><?php echo mo_get_data(1, 4); ?></b></h1>
                    <div style="display: inline-block;" class="uni_response">
                        <div style="width: 98%;">
                            <div class="image_box"><img src="../userfiles/<?php echo mo_get_data(2, 4); ?>"></div><br />
