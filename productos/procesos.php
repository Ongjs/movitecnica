...
?>
    <input type="button" value="►" title="buscar" id="buscar" style=" float: right;"><input type="text" name="buscar_prod" value="" id="prod" size="42" style=" float: right;" placeholder="Buscar producto">
</div>
<br />
<br />
        ...
        if (sizeof($content) > 0) {
            ...
            foreach ($content as $val) {
                if (!in_array($val[0], $hidden)) {
                    if ((int) ($val[2]) == 1) {
                        ?>
                        <div style="float: left; width: 240px; text-align: center; margin-top: 20px; ">
                            <div style="margin-top: 7px; margin-bottom: 7px;">
                                <div style="width: 100%; float: left;"  data-id="<?php echo $val[0]; ?>"> <img src="../userfiles/<?php echo $val[3]; ?>" style=""></div>
