            ...
            <div id="post_grids" class="row" style=" margin-top: -20px; max-width: none;">
                ...
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%; height: auto;">
                        <div style="width: 100%; min-width: 300px;"><span>Somos una empresa peruana con mas de 30 años en el mercado Que con cuatro lineas de negocio : <br /> unidad de gruas, unidad de fajas tranportadoras, tiendas y servicio tecnico. </span><br /></div><br />
                        <div style="min-width: 250px; width: 70%; margin-right: 10px;"><img src="../images/darb.png"></div>
                        <br /><br />
                        <div style="width: 100%"> 
                        Por mas informacion porfabor mire en los siguientes Links<br/>
                        <a href="#">Link 1</a><br />
                        <a href="#">Link 2</a><br />
                        </div>
                    </div>
                    <br />
                    <a href="Media.php">Regresar a Las Noticias</a>   
                </div>
