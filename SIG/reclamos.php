                        ...
                        <div class="twelve columns">
                            ...
                            <div class="header_right">
                                <div id="top_menu" class="menu-navigation-container"><ul id="mainmenu" class="sf-menu">
                                        ...
                                        <li id="menu-item-1126"  ><a href="Sig.php">SIG</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1199"><a href="politica.php">Política</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1199"><a href="garantia.php">Garantía</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1199"><a href="reclamos.php">Reclamos</a></li>
                                            </ul>
                                        </li>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="../index.html">Inicio</a> > <a href="SIG.php">Sig</a> > Reclamos </span>
                    <br />
                    <br />
                    <h1><b>Reclamos</b></h1>
                    <div style="display: inline-block;" class="uni_response">
                        <div style="width: 98%;">
                            <div class="image_box"><img src="../images/reclamos.png"></div><br />
                            ...
                            <div>
                                <form class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="inputmail" placeholder="E-Mail">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputcompany">Compañia</label>
                                        <div class="controls">
                                            <input type="text" id="inputcompany" placeholder="Compañia">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputclaim">Motivo Reclamo</label>
                                        <div class="controls">
                                            <textarea rows="3" id="inputclaim" ></textarea><br /><br />
