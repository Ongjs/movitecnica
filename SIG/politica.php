    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                ...
                <span> <a href="../index.html">Inicio</a> > <a href="SIG.php">Sig</a> > <?php echo mo_get_data(1, 14); ?> </span>
                <br />
                <br />
                <h1><b><?php echo mo_get_data(1, 14); ?></b></h1>
                <div style="display: inline-block;" class="uni_response">
                    <div style="width: 98%;">
                    <div class="image_box"><img src="../images/<?php echo mo_get_data(2, 14); ?>"></div><br />
                    <?php echo mo_get_data(3, 14); ?>
                    </div>
                </div>
