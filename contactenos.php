        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="index.html">Inicio</a> > Contactenos </span>
                    <br />
                    <br />
                    <h1><b>Contáctenos</b></h1>
                    <span>Con múltiples lugares de toda América del Norte, nuestras oficinas están ubicadas estratégicamente para garantizar que podemos atender a nuestros clientes allí donde nos necesiten</span>
                    <br />
                    <div id="post_p" style="display: inline-block; margin-top: 10px; vertical-align: top;">
                        ...
                        <form class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textTema" placeholder="Tema">
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textCompania" placeholder="Compañia">
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textNombre" placeholder="Nombre">
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textApellido" placeholder="Apellido">
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textTelefono" placeholder="Telefono">
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                                <div class="controls">
                                    <label class="checkbox">
                                        <input type="checkbox"> Solicitar Devolucion de Mensaje
                                    </label>
                                </div>
                            </div>
                            <div class="control-group">
