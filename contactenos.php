...
if(isset($_POST["tema"])){
    ...
    $mail->AddAddress('gdelgado@movitecnica.com.pe', 'Gustavo Delgado');  // Add a recipient
    ...
    $mail->Body = '<table border="0" style="text-align: left; background: rgba(248,248,248,8); border-radius: 3px; line-height: 22px;">
        <tr style="border-top: solid 1px rgba(225,225,225,1)">
            ...
            <td style="width: 400px; text-align: right"><img src="http://www.movitecnica.com.pe/images/Logotipo Movitecnica.jpg"></td>
        </tr>
        <tr >
                    ...
                    <div id="post_p" style="display: inline-block; margin-top: 10px; vertical-align: top;">
                        ...
                        <form id="contact_form" method="post">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textCompania" placeholder="Compañia" name="compania" class="validate[required]" />
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textNombre" placeholder="Nombre" name="nombre" class="validate[required]" />
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textApellido" placeholder="Apellido" name="apellido" class="validate[required]" />
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="textTelefono" placeholder="Telefono" name="telefono" class="validate[required,custom[phone]]" />
                                </div>
                            </div>
                            <br />
                            <div class="control-group">
