    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                ...
                <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <?php echo mo_get_data(1, 7); ?></span>
                <br />
                <br />
                    <div class="image_box2"><img src="../userfiles/<?php echo mo_get_data(2, 7); ?>" style=""></div>
