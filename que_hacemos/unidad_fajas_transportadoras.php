        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="que_hacemos.php"><?php echo mo_get_data(1, 7); ?></a> > <?php echo mo_get_data(1, 9); ?></span>
                    <br />
                    <br />
                    <div class="image_box2"><img src="../userfiles/<?php echo mo_get_data(2, 9); ?>" style=""></div>
                    <br />
                    <br />
