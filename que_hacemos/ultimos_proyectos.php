    ...
    <body>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px;">
                ...
                <span> <a href="../index.html">Inicio</a> > <a href="Que_Hacemos.php">Que Hacemos</a> > <a href="Unidad_Gruas_Y_Proyectos.php">Unidad Grúas y Proyectos</a> > Últimos Proyectos</span>
                <br />
                <br />
                <h1><b>Últimos Proyectos</b></h1>
                    ...
                    <div style="width: 98%;">
                        <div style="border-bottom: 1px solid #F3F3F3;  padding-bottom: 10px; margin-top: 10px;">
                            <div style="display: inline-block; vertical-align: top; max-width: 27%; width: 27%;margin-bottom: 15px; margin-right: 30px;">
                                <a href="Proyecto.php"><img src="../images/uni3.jpg" style="min-width: 180px; height: 190px; width: 190px;"></a>
                            </div>
                            <div style="display: inline-block; vertical-align: top; max-width: 65%; margin-bottom: 15px; min-width: 400px;">
                                <a href="Proyecto.php" ><h4>Nombre</h4></a>
                                ...
                                <div style="margin-top: 5px;"><a href="Proyecto.php">Ver más</a></div>
                            </div>
                        </div>
                        <br />
                        <div style="border-bottom: 1px solid #F3F3F3;  padding-bottom: 10px; margin-top: 10px;">
