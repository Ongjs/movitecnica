    ...
    <body>  <?php  include '../class/Connection.class.php'; include '../class/Fuctions.php'; ?>
        ...
        <div class="container">	
            <div id="post_grids" class="row" style=" margin-top: -20px;">
                ...
                <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="que_hacemos.php"><?php echo mo_get_data(1, 7); ?></a> > <a href="unidad_servicio_tecnico.php"><?php echo mo_get_data(1, 11); ?></a> > <?php echo mo_get_data(1, 24); ?></span>
                <br />
                <br />
                    ...
                    <div style="width: 98%;">
                        ...
                        <div style="border-bottom: 1px solid #F3F3F3;  padding-bottom: 10px; margin-top: 10px;">
                            <div style="display: inline-block; vertical-align: top; max-width: 27%; width: 27%;margin-bottom: 15px; margin-right: 30px;">
                                <a href="servicios.php?cod=<?php echo $el[0]; ?>"><img src="../userfiles/<?php echo $el[2]; ?>" style="min-width: 180px; height: 190px; width: 190px;"></a>
                            </div>
