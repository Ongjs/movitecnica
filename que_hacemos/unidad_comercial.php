        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="que_hacemos.php"><?php echo mo_get_data(1, 7); ?></a> > <?php echo mo_get_data(1, 12); ?></span>
                    <br />
                    <br />
                    <div class="image_box2"><img src="../userfiles/<?php echo mo_get_data(2, 12); ?>" style=""></div>
                    <br />
                    <br />
                    <div style="display: inline-block;" class="uni_response">
                        <div style="width: 98%; text-align: left;">
                            <h1><b><?php echo mo_get_data(1, 12); ?></b></h1>
                            <div class="que-hacemos-contenedor"><?php echo mo_get_data(3, 12); ?></div>
                            <a href="../productos/productos.php"><span>Ver Productos &gt;</span></a>
                            <br /><br />
                        </div>
                    </div>
