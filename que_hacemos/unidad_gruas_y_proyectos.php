        ...
        <div class="container">	
            <div id="post_grids" class="row" style="margin-top: -20px;">
                <div style="margin-left: 20px;">
                    <span> <a href="../index.php"><?php echo mo_get_data(1, 1); ?></a> > <a href="que_hacemos.php"><?php echo mo_get_data(1, 7); ?></a> > <?php echo mo_get_data(1, 8); ?></span>
                    <br />
                    <br />
                    <div class="image_box2"><img src="../userfiles/<?php echo mo_get_data(2, 8); ?>" style=""></div>
                    <br />
                    <br />
                    <div style="display: inline-block;" class="uni_response">
                        <div style="width: 98%; text-align: left;">
                            <h1><b><?php echo mo_get_data(1, 8); ?></b></h1>
                            <div class="que-hacemos-contenedor"><?php echo mo_get_data(3, 8); ?></div>
                            <a href="que_hacemos/ultimos_proyectos.php"><span>Ir a &uacute;ltimos proyectos &gt;</span></a>
                            <br /><br />
                        </div>
                    </div>
                                                ...
                                                <div class="image_carousel">
                                                    <div id="foo1">
                                                        ...
                                                        foreach ($images as $image) {
                                                            echo '<a href="../userfiles/' . $image['image'] . '" rel="fancybox"> <img src="../userfiles/' . $image['thumbnail'] . '" alt="' . $image['name'] . '" /> </a>';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
